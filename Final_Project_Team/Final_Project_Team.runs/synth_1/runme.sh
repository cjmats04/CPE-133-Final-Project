...
HD_PWD='C:/Users/cjmat/Documents/School/CPE 133/CPE-133-Final-Project/Final_Project_Team/Final_Project_Team.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log FPT.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source FPT.tcl
