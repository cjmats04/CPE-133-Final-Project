...
HD_PWD='C:/Users/cjmat/Documents/School/CPE 133/CPE-133-Final-Project/Final_Project_Team/Final_Project_Team.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log FPT.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source FPT.tcl -notrace
